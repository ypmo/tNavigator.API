...
public interface IProject : IDisposable
{
    ...
    /// </returns>
    IProject GetSubProjectByName(string name, ProjectType type);
    ...
    List<string> GetListOfSubProjects(ProjectType type);
    ...
    T? RunPyCode<T>(string? file = null, string[]? files = null, string? code = null, bool save = false);
    void SaveProject();
}
