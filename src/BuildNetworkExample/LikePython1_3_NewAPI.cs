...
""");
        ...
        ND_proj.SettingSolverParametr(new SolverParameters());       
...
""");
        ...
        var df_nd_results = ND_proj.GetResults(resultName: "Result", dateTime: timestamps[1], modelObjectType: tNav.NetworkDesignerEx.NetworkModelObjectType.Pipe);
        Console.WriteLine("Done");
